<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReferredCandidateSignUp.aspx.cs" Inherits="CETRMS.ReferredCandidateSignUp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Candidate SignUp</h2>
    <hr />
    <div>
        <asp:TextBox runat="server" ID="UserName" CssClass="form-control" Placeholder="Username"></asp:TextBox><br />
        <asp:TextBox runat="server" ID="Email" CssClass="form-control" Placeholder="Email ID"></asp:TextBox><br />
        <asp:TextBox runat="server" ID="Password" TextMode="Password" CssClass="form-control" Placeholder="Password"></asp:TextBox><br />
        <asp:TextBox runat="server" ID="RCode" CssClass="form-control" Placeholder="ReferralCode" OnTextChanged="RCode_TextChanged"></asp:TextBox><br />
        <asp:Button runat="server" ID="btn" CssClass="btn btn-sm btn-success rounded-pill" Text="SignUp" OnClick="CandidateSignUpPage" />
