<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/EmployerMobileApplication.aspx.cs" Inherits="CETRMS.EmployerMobileApplication" %>
                                   ...
                                   <nav class="main-nav">
                                       ...
                                       <ul class="nav">
                                           ...
                                           <li class="scroll-to-section">
                                               <a href="EmployerMobileApplication.aspx" aria-haspopup="true" aria-expanded="false">Employer</a>
                                           </li>
                   ...
                   <div class="row">
                       <div class="col-6 col-md-4">
                           <div class="card" style="height: 50rem;">
                               <img class="card-img-top" src="IndexAssets/images/AdminUELogo.jpg" alt="Card image cap" />
                               <div class="card-body">
                                   <h5 class="card-title">Universal Education Abroad</h5>
                                   <p class="card-text">Get Hire. Apply for Jobs and get hire quickly.</p>
                               </div>
                               <ul class="list-group list-group-flush">
                                   <li class="list-group-item">MultiNational Company</li>
                                   <li class="list-group-item">100% secured Job</li>
                                   <li class="list-group-item">Trusted platform for Jobs</li>
                               </ul>
                               <div class="card-body">
                                   <div class="row">
                                       ...
                                       <div class="col">
                                           <asp:Button ID="EmpDownloadFile" runat="server" Text="Download Employer File" CssClass="btn btn-block bg-primary" Font-Size="Large" OnClick="EmpDownloadFile_Click" />
                                       </div>
                                   </div>
                               </div>
                           </div>
                       ...
                       <div class="col-md-8">
                           <div class="card">
                               ...
                               <div class="card-body">
                                   <p class="card-text">
                                       Here we provide employment services. Recruitment staff for all positions as per your company criteria and requirements.
                               ...
                               <div class="card-body">
                                 <div class="row">
                                     <div class="col-md-12">  
                                         ...
                                         <div class="col-sm-6">
                                           <img src="LandingPageAsset/img/Iphone.png" alt="" class="img-fluid"/>
                                             </div>
                                         <div class="col-sm-6 text-center justify-content-center" style="padding:40px;">
                                             <h1 style="color:orange;font-weight:600;">Universal Abroad Job!!!</h1>
                                             <p>Get Hire Now! Click the button to download app now.</p>
                                         </div>
                                         </div>
                                      </div>
                                  </div>
