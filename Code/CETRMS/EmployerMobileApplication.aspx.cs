...
namespace CETRMS
{
    public partial class EmployerMobileApplication : System.Web.UI.Page
    {
        ...
        protected void EmpDownloadFile_Click(object sender, EventArgs e)
        {
            APKDOWNLOADEMPLOYER();

        }

        protected void APKDOWNLOADEMPLOYER()
        {
            //string _Path = Server.MapPath("Setup\\"  + @"\Dhiranbooksetup.exe");
            string _Path = HttpContext.Current.Server.MapPath(@".\MobileApp\CETRMS_Employer.apk");
            ...
            if (file.Exists)
            {
                ...
                //InfoLBL.Text = "Thank you for downloading the file.";
