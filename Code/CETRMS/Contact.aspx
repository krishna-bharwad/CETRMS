<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="CETRMS.Contact" %>
                        ...
                        <div class="row">
                            <div class="col-lg-6  align-self-center">
                                <div class="section-heading">
                                    ...
                                    <address>
                                      4th floor, 402, campus corner, H.L. commerce college
road, Navrangpura, Ahmedabad, Gujarat 380009<br />
                                        <strong title="Phone">Phone:</strong>
                                        +91 992-501-40008
                                    </address>
                                    <address>
                                        <strong>Support:</strong>   <a href="mailto:Support@example.com">info@coder-edge.com</a><br />
                                        <strong>Instagram:</strong> <a href="#">loremipsum_instagram</a>
                                    </address>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="contact-us-content1">
                                    <form id="contact-form1" method="post">
                                        <div class="row">
                                            <div class="col-lg-12 mb-2">
                                                <fieldset>
                                                    <input type="text" class="input" name="name" id="name" placeholder="Your Name..." autocomplete="on" required="" />
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-12 mb-2">
                                                <fieldset>
                                                    <input type="text" class="input" name="email" title="" id="email" pattern="[^ @]*@[^ @]*" placeholder="Your E-mail..." required="" />
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-12 mb-2">
                                                <fieldset>
            ...
            <%--<footer>
                <div class="container py-vh-4 text-white fw-lighter">
                    <div class="row">
                        ...
                        <div class="col-sm border-end border-light mb-2">
                        ...
                        <div class="col-sm mb-2">
                            ...
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a href="mailto:Universal.abroadjobs23@gmail.com" class="text-white text-nowrap">EMAIL ID:- Universal.abroadjobs23@gmail.com</a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="container py-vh-4 text-white fw-lighter">
                    <div class="row">
                        ...
                        <div class="col-6 col-md-4 mb-2">
                            <span class="text-white font-weight-bold h5">SUPPORT</span>
                            <ul class="nav flex-column">
                                <li class="nav-item">EMAIL ID:- loremipsum@gmail.com<%--<a href="mailto:Universal.abroadjobs23@gmail.com" class="text-white text-wrap" style="word-break:break-all;">Universal.abroadjobs23@gmail.com</a>--%>
                                </li>
                                <li class="nav-item">
                                    <a href="Aboutus.aspx" class="text-white">ABOUT US</a>
                                </li>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content ">
                        <div class="section">
                            <div class="container">
                                <center>
                                    <img src="cetimages/CET-LOGO.png" style="width: 12rem;" /></center>
                                <div class="clearfix">
                                    <br />
                                </div>
