<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CandidateSignUp.aspx.cs" Inherits="CETRMS.CandidateSignUp" %>
...
<head runat="server">
    <title>Candidate Signup</title>
      ...
      <link href="SignUpPageResources/css/style.css" rel="stylesheet"/>
      <link href="SignUpPageResources/assets/css/main.css" rel="stylesheet"/>
      <link href="IndexAssets/css/templatemo-scholar.css" rel="stylesheet"/>
	        ...
	        <div class="container">
		        <div class="row align-items-center">
			        <div class="col-md-4 text-center order-1 order-md-1">
				        <img class="img-fluid" src="LandingPageAsset/img/UE-Iphone-X.png" alt="screenshot"/>
			        </div>
                    
                    <div class="col-md-4 order-2 order-md-2 text-center text-md-left">
				        <h1 class="text-white font-weight-bold mb-4">Welcome to the new world of opportunities.</h1>
				        <p class="text-white mb-5">An app that let you connect with hundreds of employers and thousand of opportunities</p>
	        ...
	        <div class="container">
		        <div class="rounded shadow p-5 bg-white">
			        <div class="row">
				        ...
				        <div class="col-lg-4 col-md-6 mt-5 mt-md-0 text-center">
					         <i class="fa-solid fa-user fa-2xl p-4"></i>
				        ...
				        <div class="col-lg-4 col-md-12 mt-5 mt-lg-0 text-center">
					        <i class="fa-solid fa-calendar fa-2xl p-4"></i>
