...
namespace CETRMS
{
    public partial class PrintCandidateSignup : System.Web.UI.Page
    {
        ...
        protected void GetCanSignupReport()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/CandidateSignUpReport.rdlc");
                ...
                dbCommand.Parameters.AddWithValue("@ClientTypeID", 2);
                ...
                ReportDataSource rds = new ReportDataSource("CandidateSignUpDataSet", dbDataset.Tables[0]);
