<%@ Page Title="" Language="C#" MasterPageFile="~/UEStaff.Master" AutoEventWireup="true" CodeBehind="AllEmployerList.aspx.cs" Inherits="CETRMS.AllEmployerList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <div class="col-11 d-flex">
       <%-- <img src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/90/null/external-receive-amount-online-money-service-flaticons-lineal-color-flat-icons.png" height="35" width="35"/>--%>
        <h5 class="p-2">List Of New Employer Registration</h5></div>
...
<div class="row mb-4">
    <div class="col-12 table-responsive">
        <asp:GridView ID="NewEmployerGV" runat="server" CssClass="table jambo_table bulk_action" RowStyle-CssClass="GvGrid" HeaderStyle-CssClass="GvHeader" AllowPaging="true" PageSize="10" OnPageIndexChanging="NewEmployerGV_PageIndexChanging">
           <%--<Columns>
