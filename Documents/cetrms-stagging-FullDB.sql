...
GO
/****** Object:  Schema [cet_uerms]    Script Date: 11-12-2023 18:51:35 ******/
CREATE SCHEMA [cet_uerms]
GO
/****** Object:  UserDefinedFunction [cet_uerms].[fn_CalculateAge]    Script Date: 11-12-2023 18:51:35 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	function to get age
-- =============================================
CREATE FUNCTION [cet_uerms].[fn_CalculateAge]
(
  @DOB DATE
)
RETURNS INT
...
END
GO
/****** Object:  UserDefinedFunction [cet_uerms].[fn_GetCandidateBriefProfile]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE FUNCTION [cet_uerms].[fn_GetCandidateBriefProfile] 
(
...
BEGIN
	...
	begin
		...
		if @TotalYears != 0
			SET @CandidateTotalExp = @CandidateTotalExp + CONVERT(nvarchar(4), @TotalYears) +' years'
	...
	SET @Result = (@CandidateTotalExp + @CandidateHighestQualificaiton)


	-- Add the T-SQL statements to compute the return value here
	--SELECT @Result = @CandidateID
...
END
GO
/****** Object:  UserDefinedFunction [cet_uerms].[fn_GetCityName]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Author:		Prashant Sharma
-- Create date: 13-04-2023
-- Description:	Function to Get City Name from CityCode
-- =============================================
CREATE FUNCTION [cet_uerms].[fn_GetCityName] 
(
	-- Add the parameters for the function here
...
BEGIN
	...
	-- Add the T-SQL statements to compute the return value here
	SELECT @Result = CityName from CETCity where CityCode = @CityCode and StateCode = @StateCode
...
END
GO
/****** Object:  UserDefinedFunction [cet_uerms].[fn_GetCountryName]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Author:		Prashant Sharma
-- Create date: 13-04-2023
-- Description:	Function to get Country Name from State Code
-- =============================================
CREATE FUNCTION [cet_uerms].[fn_GetCountryName] 
(
	-- Add the parameters for the function here
	@StateCode nvarchar(10)
)
...
BEGIN
	...
	-- Add the T-SQL statements to compute the return value here
	SELECT @Result = CountryName from CETStates where StateCode = @StateCode
...
END
GO
/****** Object:  UserDefinedFunction [cet_uerms].[fn_GetExpInYears]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Author:		Prashant Sharma
-- Create date: 13-04-2023
-- Description:	Function to get experience in years
-- =============================================
CREATE FUNCTION [cet_uerms].[fn_GetExpInYears] 
(
	-- Add the parameters for the function here
	@ExpMonths int
)
...
BEGIN
	...
	if @ExpMonths = 0 OR @ExpMonths is null
	begin
		SET @CandidateTotalExp = ' Fresher '
	end
	else
	begin
		SET @CandidateTotalExp = ''

		SET @TotalYears = CONVERT(int, @ExpMonths / 12)
		SET @TotalMonths = CONVERT(int, @ExpMonths % 12)
	...
	Select @Result = (@CandidateTotalExp) 
...
END
GO
/****** Object:  UserDefinedFunction [cet_uerms].[fn_GetStateName]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Author:		Prashant Sharma
-- Create date: 13-04-2023
-- Description:	Function to get State Name from State Code
-- =============================================
CREATE FUNCTION [cet_uerms].[fn_GetStateName] 
(
	-- Add the parameters for the function here
	@StateCode nvarchar(10)
)
...
BEGIN
	...
	-- Add the T-SQL statements to compute the return value here
	SELECT @Result = StateName from CETStates where StateCode = @StateCode
...
END
GO
/****** Object:  UserDefinedFunction [cet_uerms].[fn_RCGetInterviewListByEmployerId]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to Rec Count
-- =============================================
CREATE FUNCTION [cet_uerms].[fn_RCGetInterviewListByEmployerId] 
(
	-- Add the parameters for the function here
	@EmployerID int,
...
BEGIN
	...
	-- Add the T-SQL statements to compute the return value here
	--EXEC [sp_GetInterviewListByEmployerId] @EmployerID, @EInterviewStatus
	SELECT @Result = 1
...
END
GO
/****** Object:  View [cet_uerms].[NewID]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [cet_uerms].[NewID] as select newid() as new_id
GO
/****** Object:  Table [cet_uerms].[CETAuthenticationType]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETAuthenticationType](
	[CETAuthenticationType] [int] NOT NULL,
	[CETAuthenticationTypeName] [nvarchar](50) NOT NULL,
 CONSTRAINT [PK_CETAuthenticationType] PRIMARY KEY CLUSTERED 
(
	[CETAuthenticationType] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETCandidate]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETCandidate](
	[CandidateId] [int] NOT NULL,
	[Name] [nvarchar](200) NOT NULL,
	[GivenName] [nvarchar](200) NULL,
	[LegalGuardianName] [nvarchar](200) NULL,
	[Surname] [nvarchar](200) NULL,
	[CandidateEmail] [nvarchar](200) NULL,
	[RegistrationDate] [date] NULL,
	[CandidateIntro] [nvarchar](max) NULL,
	[DateOfbirth] [date] NULL,
	[ContactNumberCountryCode] [nchar](10) NULL,
	[ContactNumber] [nchar](15) NULL,
	[Gender] [int] NULL,
	[NoticePeriod] [int] NULL,
	[Status] [int] NULL,
	[ValidationOTP] [nchar](10) NULL,
	[ReferralCode] [nchar](8) NULL,
	[Photo] [varbinary](max) NULL,
	[PermanentAddress] [nvarchar](max) NULL,
	[CurrentAddress] [nvarchar](50) NULL,
	[MaritalStatus] [nvarchar](50) NULL,
	[Nationality] [nvarchar](200) NULL,
	[ResumeFileType] [nvarchar](50) NULL,
	[ResumeFileName] [nvarchar](100) NULL,
	[ResumeData] [varbinary](max) NULL,
	[LastUpdatedOn] [datetime] NULL,
	[PassportFileType] [nvarchar](50) NULL,
	[PassportFileName] [nvarchar](100) NULL,
	[PassportData] [varbinary](max) NULL,
	[VisaTypeID] [int] NULL,
	[VisaDetails] [nvarchar](max) NULL,
	[VisaValidUpto] [date] NULL,
	[VisaFileType] [nvarchar](50) NULL,
	[VisaFileName] [nvarchar](100) NULL,
	[VisaData] [varbinary](max) NULL,
	[MotherName] [nvarchar](200) NULL,
	[SpouseName] [nvarchar](200) NULL,
	[PassportIssueDate] [date] NULL,
	[PassportExpiryDate] [date] NULL,
	[PassportNumber] [nvarchar](50) NULL,
	[PassportIssueLocation] [nvarchar](200) NULL,
	[HighestQualification] [nvarchar](200) NULL,
	[UniversityName] [nvarchar](512) NULL,
	[UniversityLocation] [nvarchar](200) NULL,
	[QualificationYear] [nchar](10) NULL,
	[CandidateCast] [nvarchar](200) NULL,
	[TotalExperienceMonths] [int] NULL,
	[IsCandidateReferred] [int] NULL,
	[PermanentStateCode] [nchar](10) NULL,
	[PermanentCityCode] [nchar](10) NULL,
	[CurrentStateCode] [nchar](10) NULL,
	[CurrentCityCode] [nchar](10) NULL,
	[BankAccountNumber] [nvarchar](50) NULL,
	[IFSCCode] [nvarchar](50) NULL,
	[VerifyEmail] [int] NULL,
 CONSTRAINT [PK_CETCandidate] PRIMARY KEY CLUSTERED 
(
	[CandidateId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETCandidateProfileStatus]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETCandidateProfileStatus](
	[CETCandidateProfileStatusTypeID] [int] IDENTITY(1,1) NOT NULL,
	[CETCandidateProfileStatusTypeName] [nvarchar](200) NULL,
 CONSTRAINT [PK_CETCandidateProfileStatusType] PRIMARY KEY CLUSTERED 
(
	[CETCandidateProfileStatusTypeID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETCandidateStatusType]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETCandidateStatusType](
	[CETCandidateStatusTypeID] [int] IDENTITY(1,1) NOT NULL,
	[CETCandidateStatusTypeName] [nvarchar](200) NULL,
 CONSTRAINT [PK_CETCandidateStatusType] PRIMARY KEY CLUSTERED 
(
	[CETCandidateStatusTypeID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETCity]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETCity](
	[RecId] [int] IDENTITY(1,1) NOT NULL,
	[StateCode] [nchar](10) NULL,
	[CityCode] [nchar](10) NULL,
	[CityName] [nvarchar](200) NULL,
 CONSTRAINT [PK_CETCity] PRIMARY KEY CLUSTERED 
(
	[RecId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETClient]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETClient](
	[ClientID] [int] IDENTITY(1,1) NOT NULL,
	[ClientTypeID] [int] NOT NULL,
	[ClientStatusTypeID] [int] NOT NULL,
	[CETAdminID] [nvarchar](200) NOT NULL,
	[LatestReceiptId] [int] NOT NULL,
	[Password] [nvarchar](max) NULL,
	[AuthenticationType] [int] NULL,
	[AuthenticationID] [nvarchar](200) NULL,
	[AuthenticationName] [nvarchar](512) NULL,
	[AuthenticationProfileURL] [nvarchar](512) NULL,
	[SignedUpOn] [datetime] NULL,
 CONSTRAINT [PK_CETClient] PRIMARY KEY CLUSTERED 
(
	[ClientID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETClientStatusType]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETClientStatusType](
	[ClientStatusTypeID] [int] IDENTITY(1,1) NOT NULL,
	[ClientStatusTypeName] [nvarchar](200) NOT NULL,
 CONSTRAINT [PK_CETClientStatusType] PRIMARY KEY CLUSTERED 
(
	[ClientStatusTypeID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETClientType]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETClientType](
	[ClientTypeID] [int] IDENTITY(1,1) NOT NULL,
	[ClientTypeName] [nvarchar](200) NOT NULL,
 CONSTRAINT [PK_CETClientType] PRIMARY KEY CLUSTERED 
(
	[ClientTypeID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETCompanyDetails]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETCompanyDetails](
	[CompanyBillingName] [nvarchar](200) NULL,
	...
	[WhatsaAppMobileNo] [nvarchar](50) NULL,
	[CompanyWebURL] [nvarchar](200) NULL,
	[SupportEmailAddress] [nvarchar](200) NULL,
	[SupportContactNumber] [nvarchar](50) NULL,
	[NoReplyEmail] [nvarchar](200) NULL,
	[SupportEmail] [nvarchar](200) NULL,
	[NewsLetterEmail] [nvarchar](200) NULL,
	[AccountsEmail] [nvarchar](200) NULL,
	[InfoEmail] [nvarchar](200) NULL,
	[ReferralRegistrationLink] [nvarchar](max) NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETEmployer]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETEmployer](
	...
	[EmployerStatus] [int] NULL,
	[LocationStateCode] [nchar](10) NULL,
	[LocationCityCode] [nchar](10) NULL,
	[RegisteredOn] [datetime] NULL,
	[UpdateOn] [datetime] NULL,
	[VerifyEmail] [int] NULL,
 CONSTRAINT [PK_CETEmployer] PRIMARY KEY CLUSTERED 
(
	[EmployerID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETEmployerStatus]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETEmployerStatus](
	[CETEmployerStatusTypeID] [int] IDENTITY(1,1) NOT NULL,
	[CETEmployerStatusTypeName] [nvarchar](200) NULL,
 CONSTRAINT [PK_CETEmployerStatusType] PRIMARY KEY CLUSTERED 
(
	[CETEmployerStatusTypeID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETInterviews]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETInterviews](
 ...
 CONSTRAINT [PK_CETInterviews] PRIMARY KEY CLUSTERED 
(
	[InterviewID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETJobApplicationStatusType]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETJobApplicationStatusType](
	[ApplicationStatusID] [int] IDENTITY(1,1) NOT NULL,
	[ApplicationStatusName] [nvarchar](200) NULL,
 CONSTRAINT [PK_[ApplicationStatusID] PRIMARY KEY CLUSTERED 
(
	[ApplicationStatusID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETNotification]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETNotification](
	[NotificationID] [int] IDENTITY(1,1) NOT NULL,
	[NotificationTime] [datetime] NULL,
	[NotificationType] [nchar](10) NULL,
	[NotificationMessage] [nvarchar](max) NULL,
	[CETClientID] [int] NULL,
	[NotificationStatus] [int] NULL,
	[HyperLink] [nvarchar](max) NULL,
 CONSTRAINT [PK_CETNotification] PRIMARY KEY CLUSTERED 
(
	[NotificationID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETNotificationStatus]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETNotificationStatus](
	[NotificationStatusID] [int] IDENTITY(1,1) NOT NULL,
	[NotificationStatusName] [nvarchar](50) NOT NULL,
 CONSTRAINT [PK_CETNotificationStatus] PRIMARY KEY CLUSTERED 
(
	[NotificationStatusID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETNotificationType]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETNotificationType](
	[NotificationTypeID] [int] IDENTITY(1,1) NOT NULL,
	[NotificationTypename] [nvarchar](50) NULL,
 CONSTRAINT [PK_CETNotificationType] PRIMARY KEY CLUSTERED 
(
	[NotificationTypeID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETPaymentLog]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETPaymentLog](
	[LogID] [int] IDENTITY(1,1) NOT NULL,
	[PaymentRecID] [int] NOT NULL,
	[LogDateTime] [datetime] NOT NULL,
	[PaymentStatus] [int] NOT NULL,
	[PaymentLog] [nvarchar](max) NOT NULL,
 CONSTRAINT [PK_CETPaymentLog] PRIMARY KEY CLUSTERED 
(
	[LogID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETPayments]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETPayments](
	[PaymentRecID] [int] IDENTITY(1,1) NOT NULL,
	[PaymentOrderNo] [nvarchar](50) NULL,
	...
	[StripePaymentID] [nvarchar](512) NULL,
	[StripePaymentDate] [datetime] NULL,
	[StripePaymentStatus] [nvarchar](128) NULL,
	[StripePaymentMessage] [nvarchar](max) NULL,
	[StripePaymentReceiptURL] [nvarchar](max) NULL,
	[StripePaymentMethod] [nvarchar](128) NULL,
	[TaxAmount] [float] NULL,
	[InvoiceNo] [int] NULL,
	[Reserve1] [int] NULL,
	[Reserve2] [int] NULL,
 CONSTRAINT [PK_CETPayments] PRIMARY KEY CLUSTERED 
(
	[PaymentRecID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETPaymentStatus]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETPaymentStatus](
	[PaymentStatusTypeID] [int] IDENTITY(1,1) NOT NULL,
	[PaymentStatusTypeName] [nvarchar](50) NULL,
 CONSTRAINT [PK_CETPaymentStatus] PRIMARY KEY CLUSTERED 
(
	[PaymentStatusTypeID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETPaymentType]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETPaymentType](
	[PaymentTypeID] [int] IDENTITY(1,1) NOT NULL,
	[PaymentTypeName] [nvarchar](50) NULL,
	[Amount] [float] NULL,
	[AmountType] [nchar](10) NULL,
	[TransactionType] [nchar](10) NULL,
	[DueDays] [int] NULL,
	[Currency] [nvarchar](10) NULL,
	[Tax] [float] NULL,
 CONSTRAINT [PK_CETPaymentType] PRIMARY KEY CLUSTERED 
(
	[PaymentTypeID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETReferral]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETReferral](
	[ReferralID] [int] IDENTITY(1,1) NOT NULL,
	[CETCandidateID] [int] NOT NULL,
	[ReferralStatus] [int] NULL,
	[ReferralCode] [nvarchar](50) NULL,
 CONSTRAINT [PK_CETReferral] PRIMARY KEY CLUSTERED 
(
	[ReferralID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETStaff]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETStaff](
 ...
 CONSTRAINT [PK_CETStaff] PRIMARY KEY CLUSTERED 
(
	[userid] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETStates]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETStates](
	[RecID] [int] IDENTITY(1,1) NOT NULL,
	[CountryName] [nvarchar](50) NULL,
	[StateName] [nvarchar](50) NULL,
	[StateCode] [nchar](10) NULL,
	[CurrencyName] [nvarchar](6) NULL,
	[CurrencySymbol] [nvarchar](6) NULL,
 CONSTRAINT [PK_CETStates] PRIMARY KEY CLUSTERED 
(
	[RecID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETTestimonials]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETTestimonials](
	[RecID] [int] IDENTITY(1,1) NOT NULL,
	[CETClientID] [int] NULL,
	...
	[IsShown] [int] NULL,
 CONSTRAINT [PK_CETTestimonials] PRIMARY KEY CLUSTERED 
(
	[RecID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETVacancies]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETVacancies](
	[VacancyID] [int] IDENTITY(1,1) NOT NULL,
	[CETEmployerId] [int] NOT NULL,
	[VacancyStatusTypeId] [int] NULL,
	[VacancyName] [nvarchar](200) NULL,
	[VacancyCode] [nchar](10) NULL,
	[PrimaryLocation] [nvarchar](200) NULL,
	[JobType] [nchar](10) NULL,
	[EmployementStatus] [nvarchar](50) NULL,
	[CandidatesRequired] [int] NULL,
	[RequiredMinExp] [int] NULL,
	[RequiredMinQualification] [nvarchar](50) NULL,
	[PostingDate] [date] NULL,
	[VacancyDetails] [nvarchar](max) NULL,
	[SalaryOffered] [float] NULL,
	[SalaryCycle] [nvarchar](10) NULL,
	[FilledSeats] [int] NULL,
 CONSTRAINT [PK_CETVacancies] PRIMARY KEY CLUSTERED 
(
	[VacancyID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETVacancyStatusType]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETVacancyStatusType](
	[VacancyStatusTypeId] [int] IDENTITY(1,1) NOT NULL,
	[VacancyStatusTypeName] [nvarchar](200) NULL,
 CONSTRAINT [PK_CETVacancyStatusType] PRIMARY KEY CLUSTERED 
(
	[VacancyStatusTypeId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[CETVisaType]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[CETVisaType](
	[RecID] [int] IDENTITY(1,1) NOT NULL,
	[VisaTypeName] [nvarchar](50) NOT NULL,
	[VisaCountry] [nvarchar](100) NULL,
	[VisaValidity] [nvarchar](50) NULL,
	[VisaTypeDetails] [nvarchar](max) NULL,
	[VisaStateCode] [nvarchar](50) NULL,
 CONSTRAINT [PK_CETVisaType] PRIMARY KEY CLUSTERED 
(
	[RecID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[JobApplications]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[JobApplications](
...
GO
/****** Object:  Table [cet_uerms].[log]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[log](
	[LogId] [int] IDENTITY(1,1) NOT NULL,
	[EventId] [int] NOT NULL,
	[UserName] [nvarchar](100) NULL,
	[LogTime] [datetime] NOT NULL,
	[LogSeverity] [nchar](3) NOT NULL,
...
GO
/****** Object:  Table [cet_uerms].[logEvent]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[logEvent](
	[logEventId] [int] IDENTITY(1,1) NOT NULL,
	[logEventCode] [nchar](30) NOT NULL,
	[logEventDetail] [varchar](256) NOT NULL,
...
GO
/****** Object:  Table [cet_uerms].[MISUsers]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[MISUsers](
	[UserRecNo] [int] IDENTITY(1,1) NOT NULL,
	[UserID] [nvarchar](50) NOT NULL,
	[Password] [nvarchar](max) NULL,
	[UserType] [int] NULL,
	[UserRights] [int] NULL,
	...
	[UserStatus] [int] NULL,
 CONSTRAINT [PK_MISUsers] PRIMARY KEY CLUSTERED 
(
	[UserRecNo] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[MISUserType]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[MISUserType](
	[MISUserTypeId] [int] NOT NULL,
	[MISUserTypeName] [nvarchar](100) NOT NULL,
	[OfficeDepartment] [int] NULL,
 CONSTRAINT [PK_MISUserType] PRIMARY KEY CLUSTERED 
(
	[MISUserTypeId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[Temp_CETCandidate]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[Temp_CETCandidate](
	[RecID] [int] NOT NULL,
	[CandidateRecID] [nvarchar](50) NULL,
	[CandidateType] [int] NULL,
	[JobOpeningCode] [int] NULL,
	[CandidateFirstName] [nvarchar](200) NULL,
	[CandidateMiddleName] [nvarchar](200) NULL,
	[CandidateLastName] [nvarchar](200) NULL,
	[CandidateEmail] [nvarchar](200) NULL,
	...
	[NoticePeriod] [int] NULL,
	[CompanyRemark] [nvarchar](max) NULL,
	[Status] [int] NULL,
	[OTP] [nchar](10) NULL,
	[RCode] [nchar](8) NULL,
	[Photo] [varbinary](max) NULL,
	...
	[PermanentCountry] [nvarchar](200) NULL,
	...
	[ResumeFileName] [nvarchar](100) NULL,
	[ResumeData] [varbinary](max) NULL,
	[CETEmpName] [nvarchar](100) NULL,
	[CETEmpCode] [nvarchar](50) NULL,
	[LinkedInProfile] [nvarchar](max) NULL,
	[LastUpdatedOn] [datetime] NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [cet_uerms].[ZoomTimeZone]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [cet_uerms].[ZoomTimeZone](
	[ZTZID] [int] IDENTITY(1,1) NOT NULL,
	[ZTZName] [nvarchar](200) NOT NULL,
	[CityName] [nvarchar](200) NOT NULL,
	[UTCTZName] [nvarchar](50) NOT NULL,
	[UTCTZDiff] [float] NOT NULL,
 CONSTRAINT [PK_ZoomTimeZone] PRIMARY KEY CLUSTERED 
(
	[ZTZID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_AddNewCity]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_AddNewCity] 
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_AddNewCountry]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_AddNewCountry] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_AddNewStaffMember]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_AddNewStaffMember] 
	-- Add the parameters for the stored procedure here
	@Name nvarchar(100),
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_AddNewState]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_AddNewState] 
	-- Add the parameters for the stored procedure here
	@CountryName nvarchar(128), 
	@StateName nvarchar(128)
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_AddPaymentLog]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_AddPaymentLog] 
	-- Add the parameters for the stored procedure here
	@PaymentRecID int,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_AddTestimonial]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_AddTestimonial] 
	-- Add the parameters for the stored procedure here
	@CETClientID int,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_AddVacancy]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_AddVacancy] 
	-- Add the parameters for the stored procedure here
      @UEEmployerId int,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_AuthenticateUEClient]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_AuthenticateUEClient] 
	-- Add the parameters for the stored procedure here
	@UserId nvarchar(50), 
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_AuthenticateUser]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_AuthenticateUser] 
	-- Add the parameters for the stored procedure here
	@UserId nvarchar(50), 
	@Password nvarchar(MAX)  
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_CandidateMobileAppDashboard]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_CandidateMobileAppDashboard] 
	-- Add the parameters for the stored procedure here
	@CandidateId int 
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_CandidateSignUp]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_CandidateSignUp] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_ChangePassword]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_ChangePassword]
	-- Add the parameters for the stored procedure here
	@UserID nvarchar(50),
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_ChangeTestimonialStatus]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_ChangeTestimonialStatus] 
	-- Add the parameters for the stored procedure here
	@TestimonialID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_CreateNewZoomMeeting]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_CreateNewZoomMeeting] 
	-- Add the parameters for the stored procedure here
	@InterviewID int = 0, 
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_EmployerSignUp]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_EmployerSignUp] 
	-- Add the parameters for the stored procedure here
	@UEAuthenticationType int = 0, 
	@AuthenticationID nvarchar(50),
	@AuthenticationName nvarchar(512),
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GeCandidateListByLocation]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GeCandidateListByLocation] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GeCandidateListByLocation2]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to get list of candidate
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GeCandidateListByLocation2] 
	-- Add the parameters for the stored procedure here
	@JobLocation nvarchar(200),
	@CandidateStatus int=0													--Edited By Krishna Bharwad
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCandidateBriefProfile]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to Get Candidate Brief Profile
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCandidateBriefProfile] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCandidateContactDetails]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCandidateContactDetails]
	-- Add the parameters for the stored procedure here
	@CandidateID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCandidateDashboard]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCandidateDashboard] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCandidateFullDetails]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCandidateFullDetails] 
	-- Add the parameters for the stored procedure here
	@CandidateID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCandidateFullDetailsForReport]    Script Date: 11-12-2023 18:51:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to Get Candidate Details
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCandidateFullDetailsForReport] 
	-- Add the parameters for the stored procedure here
	@CandidateID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCandidateOtherDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCandidateOtherDetails]
	-- Add the parameters for the stored procedure here
	@CandidateID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCandidatePassportDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCandidatePassportDetails]
	-- Add the parameters for the stored procedure here
	@CandidateID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCandidatePersonalDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCandidatePersonalDetails]
	-- Add the parameters for the stored procedure here
	@CandidateID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCandidateQualificationDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCandidateQualificationDetails]
	-- Add the parameters for the stored procedure here
	@CandidateID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCandidateVisaDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCandidateVisaDetails]
	-- Add the parameters for the stored procedure here
	@CandidateID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetClientDetailsForInvoice]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetClientDetailsForInvoice] 
	-- Add the parameters for the stored procedure here
	@CETClientID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCompanyDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCompanyDetails] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetCountryList]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetCountryList] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetEmployerDashboard]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetEmployerDashboard] 
	-- Add the parameters for the stored procedure here
AS
BEGIN
	-- SET NOCOUNT ON added to prevent extra result sets from
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetEmployerDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetEmployerDetails] 
	-- Add the parameters for the stored procedure here
	@EmployerID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetEmployerDetailsForReport]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetEmployerDetailsForReport] 
	-- Add the parameters for the stored procedure here
	@EmployerID int
AS
BEGIN
...
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetEmployerList]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetEmployerList] 
	-- Add the parameters for the stored procedure here
	@EmployerStatus int
AS
BEGIN
...
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetEmployerListByLocation]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to Get Employer List
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetEmployerListByLocation] 
	-- Add the parameters for the stored procedure here
...
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetEmployerMobileAppDashboard]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetEmployerMobileAppDashboard] 
	-- Add the parameters for the stored procedure here
	@EmployerID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetIndexPageParameters]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetIndexPageParameters] 
	-- Add the parameters for the stored procedure here
AS
BEGIN
	-- SET NOCOUNT ON added to prevent extra result sets from
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetInterviewDashboard]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetInterviewDashboard] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetInterviewDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetInterviewDetails] 
	-- Add the parameters for the stored procedure here
	@InterviewID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetInterviewListByCandidateId]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetInterviewListByCandidateId] 
	-- Add the parameters for the stored procedure here
	@CandidateID int,
	@InterviewStatus int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetInterviewListByDate]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetInterviewListByDate] 
	-- Add the parameters for the stored procedure here
	@InterviewDate Date,
	@InterviewStatus int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetInterviewListByEmployerId]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetInterviewListByEmployerId] 
	-- Add the parameters for the stored procedure here
	@EmployerID int,
	@EInterviewStatus int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetInterviewListByStatus]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetInterviewListByStatus] 
	-- Add the parameters for the stored procedure here
	@InterviewStatus int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetInterviewListByStatusForReport]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to Get Interview List By Status
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetInterviewListByStatusForReport] 
	-- Add the parameters for the stored procedure here
	@InterviewStatus int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetInterviewListByVacancyId]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to Get Interview List By Vacancy
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetInterviewListByVacancyId] 
	-- Add the parameters for the stored procedure here
	@VacancyId int,
	@InterviewStatus int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetJobApplicationDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetJobApplicationDetails] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetMaskedCandidateDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetMaskedCandidateDetails] 
	-- Add the parameters for the stored procedure here
	@JobApplicationID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetMaskedCandidateListByEmployer]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetMaskedCandidateListByEmployer] 
	-- Add the parameters for the stored procedure here
	@EmployerID int = 0, 
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetMaskedCandidateListByLocation]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetMaskedCandidateListByLocation] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetMaskedCandidateListByVacancy]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetMaskedCandidateListByVacancy] 
	-- Add the parameters for the stored procedure here
	@VacancyID int = 0, 
	@CandidateStatus int = 0
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetMaskedInterviewDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetMaskedInterviewDetails] 
	-- Add the parameters for the stored procedure here
	@InteviewID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetMaskedInterviewListByCandidateId]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to Get Interview List By Candidate
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetMaskedInterviewListByCandidateId] 
	-- Add the parameters for the stored procedure here
	@CandidateID int,
	@EInterviewStatus int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetMaskedInterviewListByEmployerId]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to Get Interview List By Employer
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetMaskedInterviewListByEmployerId] 
	-- Add the parameters for the stored procedure here
	@EmployerID int,
	@EInterviewStatus int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetNotificationDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetNotificationDetails] 
	-- Add the parameters for the stored procedure here
	@NotificationID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetNotificationList]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetNotificationList] 
	-- Add the parameters for the stored procedure here
	@CETClientID int,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetNotificationSummary]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetNotificationSummary] 
	-- Add the parameters for the stored procedure here
	@CETClientID int,
	@NotificationType int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetOpenVacancyListByLocation]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetOpenVacancyListByLocation] 
	-- Add the parameters for the stored procedure here
	@JobLocation nvarchar(200),
	@VacancyStatus int = 0
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetPaymentDashboard]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetPaymentDashboard] 
	-- Add the parameters for the stored procedure here
	@CETClientID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetPaymentDashboardByPeriod]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetPaymentDashboardByPeriod] 
	-- Add the parameters for the stored procedure here
	@FromDate Date,
	@ToDate Date
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetPaymentDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetPaymentDetails] 
	-- Add the parameters for the stored procedure here
	@PaymentRecID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetPaymentList]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetPaymentList] 
	-- Add the parameters for the stored procedure here
	@CETClientID int,
	@PaymentStatus int,
	@PaymentType int
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetPaymentListByPeriod]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetPaymentListByPeriod] 
	-- Add the parameters for the stored procedure here
	@CETClientID int,
	@PaymentStatus int,
	@PaymentType int,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetPaymentListForReport]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to Get Payment List
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetPaymentListForReport] 
	-- Add the parameters for the stored procedure here
	@CETClientID int,
	@PaymentStatus int,
	@PaymentType int
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetPaymentLog]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetPaymentLog]
	-- Add the parameters for the stored procedure here
	 @CETClientID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetPaymentLogByRecID]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description: Stored Procedure for GetPaymentLog
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetPaymentLogByRecID]
	-- Add the parameters for the stored procedure here
	 @PaymentRecID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetPaymentReport]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetPaymentReport] 
	-- Add the parameters for the stored procedure here
	@CETClientID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetReferralDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetReferralDetails]
	-- Add the parameters for the stored procedure here
	@ReferralID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetReferralDetailsByStatus]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetReferralDetailsByStatus]
	-- Add the parameters for the stored procedure here
	@ReferralStatus int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetReferralPaidListForReport]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetReferralPaidListForReport]
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetSignUpDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetSignUpDetails] 
	-- Add the parameters for the stored procedure here
	@ClientTypeID int
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetStaffDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetStaffDetails] 
	-- Add the parameters for the stored procedure here
	@userid nvarchar(50)
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetStateList]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetStateList] 
	-- Add the parameters for the stored procedure here
	@CountryCode nchar(3)
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetStateListByVacancyStatus]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetStateListByVacancyStatus] 
	-- Add the parameters for the stored procedure here
	@VacancyStatus int
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetTestimonialList]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetTestimonialList] 
	-- Add the parameters for the stored procedure here
	@IsShown int,
	@Rating int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetVacancyDashboard]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetVacancyDashboard] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetVacancyDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetVacancyDetails] 
	-- Add the parameters for the stored procedure here
	@VacancyID int 
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetVacancyDetailsForReport]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to get details of vacancy
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetVacancyDetailsForReport] 
	-- Add the parameters for the stored procedure here
	@VacancyID int 
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetVacancyListByEmployer]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetVacancyListByEmployer] 
	-- Add the parameters for the stored procedure here
	@EmployerID int,
	@VacancyStatus int = 0
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetVacancyListByLocation]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to get list of vacancies by Employer
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetVacancyListByLocation] 
	-- Add the parameters for the stored procedure here
	@JobLocation nvarchar(200),
	@VacancyStatus int = 0
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetVacancyListByLocationPageWise]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetVacancyListByLocationPageWise]  
	-- Add the parameters for the stored procedure here
	@JobLocation nvarchar(200),
	@VacancyStatus int = 0,
	@PageIndex INT = 1,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_GetVisaTypeList]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_GetVisaTypeList] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_InsertDuePayment]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_InsertDuePayment] 
	-- Add the parameters for the stored procedure here
	@Currency nchar(4), 
	@Amount float,
	@TaxAmount float,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_InsertJobApplication]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_InsertJobApplication] 
	-- Add the parameters for the stored procedure here
	@VacancyID int,
	@CandidateID int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_InsertNewNotification]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_InsertNewNotification] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_InsertReferralDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_InsertReferralDetails] 
	-- Add the parameters for the stored procedure here
	@UECandidateID int, 
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_JobApplicationList]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_JobApplicationList] 
	-- Add the parameters for the stored procedure here
	@VacancyID int,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_JobApplicationListByCandidate]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_JobApplicationListByCandidate] 
	-- Add the parameters for the stored procedure here
	@CandidateID int,
	@ApplicationStatus int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_JobApplicationListByEmployer]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored Procedure to get List of Job Applications on chosen vacancy
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_JobApplicationListByEmployer] 
	-- Add the parameters for the stored procedure here
	@EmployerID int,
	@ApplicationStatus int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_JobApplicationStatistics]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_JobApplicationStatistics] 
	-- Add the parameters for the stored procedure here
	@VacancyID int
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_ProposeNewInterview]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_ProposeNewInterview] 
	-- Add the parameters for the stored procedure here
	@JobApplicationID int, 
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_RemoveUEClient]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_RemoveUEClient] 
	-- Add the parameters for the stored procedure here
	@CETClientID int,
	@UEClientType int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateBankAccountDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateBankAccountDetails]
	-- Add the parameters for the stored procedure here
	@CandidateID int, 
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateCandidateContactDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateCandidateContactDetails] 
	-- Add the parameters for the stored procedure here
	@CandidateId int,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateCandidateOtherDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateCandidateOtherDetails] 
	-- Add the parameters for the stored procedure here
	@CandidateId int,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateCandidatePassportDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Stored procedure to update Candidate Passport Details
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateCandidatePassportDetails] 
	-- Add the parameters for the stored procedure here
	@CandidateId int,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateCandidatePersonalProfile]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateCandidatePersonalProfile] 
	-- Add the parameters for the stored procedure here
	@CandidateId int,
	@Name nvarchar(200),
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateCandidateQualificationDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateCandidateQualificationDetails] 
	-- Add the parameters for the stored procedure here
	@CandidateId int,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateCandidateVisaDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateCandidateVisaDetails] 
	-- Add the parameters for the stored procedure here
	@CandidateId int,
	@VisaTypeID int,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateCountryDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateCountryDetails] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateEmployerDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateEmployerDetails] 
	-- Add the parameters for the stored procedure here
	@EmployerID int,
	@Name nvarchar(200),
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateJobApplicationStatus]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateJobApplicationStatus] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateNotificationStatus]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateNotificationStatus] 
	-- Add the parameters for the stored procedure here
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdatePaymentStatus]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdatePaymentStatus] 
	-- Add the parameters for the stored procedure here
	@PaymentRecID int, 
	@PaymentStatus int,
    @PaymentDate date,
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdatePaymentTable]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdatePaymentTable] 
	-- Add the parameters for the stored procedure here
AS
BEGIN
		-- 1 - Declare Variables
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateStaffMemberDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateStaffMemberDetails] 
	-- Add the parameters for the stored procedure here
	@userid nvarchar(50),
	@Name nvarchar(100),
	@Address nvarchar(max),
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateVacancyDetails]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateVacancyDetails] 
	-- Add the parameters for the stored procedure here
      @VacancyID int,
      @VacancyName nvarchar(200),
      @PrimaryLocation nvarchar(200),
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateVacancyStatus]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateVacancyStatus] 
	-- Add the parameters for the stored procedure here
      @VacancyID int,
	  @VacancyStatus int
AS
...
END
GO
/****** Object:  StoredProcedure [cet_uerms].[sp_UpdateZoomMeetingStatus]    Script Date: 11-12-2023 18:51:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [cet_uerms].[sp_UpdateZoomMeetingStatus] 
	-- Add the parameters for the stored procedure here
	@InterviewID int, 
